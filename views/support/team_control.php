                    ...
                    <div class="support-team-content__info">
                        ...
                        <div class="support-team-content__list">
                            <div class="support-team-content__item">
                                ...
                                <span class="support-team-content__para"></span>
    ...
    <div class="modal-dialog modal-sm">
        <form class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="team-button" type="button" class="btn btn-primary" data-bs-dismiss="modal">Chọn</button>
            </div>
        </form>
    </div>
</div>
